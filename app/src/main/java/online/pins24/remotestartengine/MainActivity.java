...
public class MainActivity extends Activity
{
    ...
    {
        bActivateDevice = (Button) findViewById(R.id.bActivateDevice);
        bResetDevice = (Button) findViewById(R.id.bResetDevice);
        bStartEngine = (Button) findViewById(R.id.bStartEngine);
        bStopEngine = (Button) findViewById(R.id.bStopEngine);
        etPhone = (EditText) findViewById(R.id.etPhone);
        tvTimer = (TextView) findViewById(R.id.tvTimer);
        tvTempNotifIsActive = (TextView) findViewById(R.id.tvTempNotif);
    ...
    private void imgChangeCar(int idDrawable)
    {
        ...
        {
            imgLayout.setBackgroundDrawable(getBaseContext().getResources().getDrawable(idDrawable));
        }
        else
        {
            imgLayout.setBackground(getBaseContext().getResources().getDrawable(idDrawable));
        }
    }
    //endregion
    ...
    private void playEngineReady()
    {
        ...
        mp = MediaPlayer.create(context, R.raw.ready_long);
        try
        {
            if (mp.isPlaying())
            {
